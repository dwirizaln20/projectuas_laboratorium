                ...
                <table class="table table-striped" id="sortable-table">
                  <tbody class="ui-sortable">
                    ...
                    <tr>
                      ...
                      <td>:</td>
                      <td>
                        <a href="<?= site_url('peminjam/download_bukti'); ?>/<?= $peminjam->id_peminjaman; ?>" class="btn btn-sm btn-outline-success"><span><i class="fas fa-download"></i></span> Download</a>
                      </td>
                    </tr> 
                    <?php endif ?>
                  </tbody>
          ...
          <div class="card">
            ...
            <div class="card-footer text-right bg-whitesmoke">
              <?php if ($peminjam->kode_status == null): ?>
                <a href="<?= site_url('peminjam/edit'); ?>/<?= $peminjam->id_peminjaman; ?>" class="btn btn-sm btn-warning">Edit Peminjaman</a>
                <a href="<?= site_url('peminjam/batalkan_permohonan'); ?>/<?= $peminjam->id_peminjaman; ?>" onclick="return confirm('Apa Anda Ingin Membatalkan Peminjaman')" class="btn btn-sm btn-danger">Batalkan Peminjaman</a>
              <?php endif ?>
            </div>
          </div>
        </div>
